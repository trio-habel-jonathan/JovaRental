<x-user-layout title="Home">
    ...
    <section id="home"
        ...
        <div class="max-w-[1600px] h-full flex items-center justify-between flex-wrap-reverse lg:flex-nowrap mx-auto">
            <div class="max-w-xl mt-4">
                ...
                <p data-aos="fade-right" data-aos-delay="150" class=" text-sm lg:text-md mb-8 font-medium ">our trusted
                    vehicle rental
                    service, offering a
                    Layanan Rental
    ...
    <section id="search" class="max-w-[1600px] mx-auto w-full flex items-center justify-center p-4 md:p-8 lg:p-12">
        <form action="" data-aos="zoom-in" data-aos-delay="150"
            class="bg-white rounded-md w-full shadow-lg border-2 p-4 grid grid-cols-1 gap-8">
            ...
            <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="mt-10">
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <dd class="mt-2 ml-16 text-justify text-xs md:text-sm lg:text-base text-gray-500 plus-jakarta-sans-font">Tidak
                                perlu khawatir
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="450">
                            ...
                            <dd class="mt-2 ml-16 text-justify text-xs md:text-sm lg:text-base text-gray-500 plus-jakarta-sans-font"> Kami
                                mengutamakan
