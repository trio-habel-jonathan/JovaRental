            ...
            <div class="w-full h-full grid grid-cols-2 relative">
                ...
                <div class="pl-8 space-y-6 flex flex-col items-center justify-center z-20">
                    ...
                    <p class="text-md montserrat-font">Layanan Rental Kendaraan Terpercaya – Sewa Mobil & Motor dengan
                        Mudah dan Terjangkau untuk Perjalanan Apa Pun. Bebas Berkendara Kapan Saja, di Mana Saja!</p>
                    <div class="w-full flex gap-4">
                        ...
                        <button
                            ...
                            <span
                                class="ml-0 w-0 overflow-hidden transition-all duration-300 ease-in-out group-hover:ml-4 group-hocurrentColor"
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="relative" data-aos="fade-up" data-aos-delay="150">
                        ...
                        <dd
                            ...
                            lengkap. Dari mobil keluarga, motor praktis, hingga kendaraan premium, kami menyediakan
                            berbagai pilihan yang sesuai dengan kebutuhan perjalanan Anda.
                        </dd>
                    </div>
                    <div class="relative" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <dd
                            ...
                            harga transparan & kompetitif, sehingga Anda bisa menikmati perjalanan tanpa beban. Hemat
                            lebih banyak, berkendara lebih nyaman!
                        </dd>
                    </div>
                    <div class="relative" data-aos="fade-up" data-aos-delay="450">
                        ...
                        <dd
                            ...
                            darurat 24/7. Dengan Jova Rental, Anda bisa bepergian dengan tenang, kapan saja dan di mana
                            saja.
                        </dd>
                    </div>
                </dl>
