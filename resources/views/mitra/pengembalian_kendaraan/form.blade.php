<x-mitra-layout title="pengembalian form">
    <form action="{{ route('mitra.pengembalian.store', ['id_unit' => $id_unit]) }}" method="POST" enctype="multipart/form-data" class="mt-6 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
