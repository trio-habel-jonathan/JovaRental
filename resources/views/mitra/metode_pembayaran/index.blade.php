<x-mitra-layout title="List Metode Pembayaran">
    <div class="p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300">
                <div class="p-6">
                    ...
                    <div class="flex space-x-2 pt-4 border-t">
                        <a href="{{ route('mitra.metodePembayaran.edit', $item->id_metode_pembayaran_mitra) }}"
            ...
            <x-modal-delete counter="{{ $loop->iteration }}"
                formAction="{{ route('mitra.metodePembayaran.destroy', $item->id_metode_pembayaran_mitra) }}"
    ...
    <a href="{{ route('mitra.metodePembayaran.create') }}"
