<x-mitra-layout title="Edit Alamat Mitra">
    <div class="m-4 p-4 rounded-xl bg-white">
        <form action="{{route('mitra.alamat.MitraUpdate', $alamatMitra->id_alamat)}}" method="POST">
            @method("PUT")
            @csrf
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="relative ">
                    ...
                    <input type="text" name="alamat"
                        ...
                        placeholder="Masukkan alamat" value="{{ old('alamat', $alamatMitra->alamat) }}" required>
                    @error('alamat')
                ...
                <div class="relative ">
                    ...
                    <input type="text" name="kota"
                        class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                        placeholder="Masukkan kota" value="{{ old('kota', $alamatMitra->kota) }}" required>
                    @error('kota')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="relative ">
                    ...
                    <input type="text" name="kecamatan"
                        class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                        placeholder="Masukkan kecamatan" value="{{ old('kecamatan', $alamatMitra->kecamatan) }}" required>
                    @error('kecamatan')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
                <div class="relative ">
                    ...
                    <input type="text" name="provinsi"
                        class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                        placeholder="Masukkan provinsi" value="{{ old('provinsi', $alamatMitra->provinsi) }}" required>
                    @error('provinsi')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="relative mb-6">
                ...
                <input type="text" name="kode_pos"
                    class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                    placeholder="Masukkan kode pos" value="{{ old('kode_pos', $alamatMitra->kode_pos) }}" required>
                @error('kode_pos')
                <span class="text-sm text-red-600">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="relative mb-6">
                ...
                <input type="text" name="no_telepon"
                    class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                    placeholder="Masukkan no telepon" value="{{ old('no_telepon', $alamatMitra->no_telepon) }}" required>
                @error('no_telepon')
                <span class="text-sm text-red-600">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 ">
                <div class="relative mb-6">
                    ...
                    <input type="text" name="latitude"
                        class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                        placeholder="Masukkan latitude" value="{{ old('latitude', $alamatMitra->latitude) }}" required>
                    @error('latitude')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
                <div class="relative mb-6">
                    ...
                    <input type="text" name="longitude"
                        class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none"
                        placeholder="Masukkan longitude" value="{{ old('longitude', $alamatMitra->longitude) }}" required>
                    @error('longitude')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
