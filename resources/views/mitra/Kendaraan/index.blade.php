                    ...
                    <div class="car-card bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="w-full md:w-2/5 p-4 bg-gray-50">
                                <img src="https://i.pinimg.com/736x/60/bb/2e/60bb2e33755e68d75546909abf92b7ed.jpg"
                                ...
                                <div class="mt-6 flex items-center justify-between border-t border-gray-100 pt-4">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('mitra.kendaraan.editkendaraanView') }}"
                                            class="px-4 py-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium flex items-center">
                                        ...
                                        <button
                                            class="px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-medium flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="mr-2">
