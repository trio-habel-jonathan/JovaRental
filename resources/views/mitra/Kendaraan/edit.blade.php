            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-0.5">
                    <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                        ...
                        <!-- Nama Kendaraan -->
                        <div class="mb-4">
                            <label for="nama-kendaraan" class="block mb-2 font-medium text-gray-700">Nama K
                                endaraan</label>
                            <div class="relative">
                    ...
                    <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                        <h2 class="text-xl font-bold text-gray-800 mb-5 flex items-center">
                            <span class="flex items-center justify-center w-10 h-10 bg-indigo-100 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600 animated-icon"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                        <h2 class="text-xl font-bold text-gray-800 mb-5 flex items-center">
                            <span class="flex items-center justify-center w-10 h-10 bg-purple-100 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600 animated-icon"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div id="upload-container">
                            ...
                            <div class="upload-counter mb-3">
                                <span id="image-count">3</span>/3 foto diunggah
                            </div>

                            <!-- Upload zone -->
                            <div id="upload-zone" class="upload-zone rounded-xl p-4 text-center cursor-pointer mb-4">
                                <div class="mb-4">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    ...
                                    <div class="relative group">
                                        <div class="relative rounded-lg overflow-hidden border border-gray-200">
                                            ...
                                            <div
                                                ...
                                                <button
                                                    class="text-white bg-red-500 hover:bg-red-600 rounded-full p-1 transition transform hover:scale-110">
                                        ...
                                        <div class="text-xs text-gray-500 mt-1 truncate text-center">Tampak Depan.jpg
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <div class="text-xs text-gray-500 mt-1 truncate text-center">Tampak_Samping.jpg
                                        </div>
                                    </div>
                                </div>
                            </div>
