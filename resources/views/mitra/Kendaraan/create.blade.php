                        ...
                        <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                            <h2 class="text-xl font-bold text-gray-800 mb-5 flex items-center">
                                <span
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-6 w-6 text-purple-600 animated-icon" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="p-4">
        <form action="{{ route('mitra.kendaraan.tambahkendaraanStore') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="gradient-background rounded-2xl p-1.5 custom-shadow mb-8">
                <div class="bg-white rounded-xl p-6 sm:p-8">
                    <div class="text-center mb-10">
                        <h1 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 inline-block mb-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="nama-kendaraan" name="nama_kendaraan" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: Toyota Avanza" required>
                                    </div>
                                ...
                                <div class="mb-4">
                                    <label for="id_kategori" class="block mb-2 font-medium text-gray-700">Kategori Kendaraan</label>
                                    <select id="id_kategori" name="id_kategori" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" required>
                                        <option value="">Pilih Kategori</option>
                                        @foreach($kategoriKendaraan as $kategori)
                                            <option value="{{ $kategori->id_kategori }}">{{ $kategori->nama_kategori }} ({{ $kategori->jenisKendaraan->nama_jenis }})</option>
                                        @endforeach
                                    </select>
                                    @error('id_kategori')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                ...
                                <div class="mb-4">
                                    <label for="tahun_produksi" class="block mb-2 font-medium text-gray-700">Tahun Pembuatan</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <input type="number" id="tahun_produksi" name="tahun_produksi" min="1900" max="2025" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: 2020" required>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="warna" name="warna" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: Putih Metalik" required>
                                    </div>
                                    @error('warna')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-0.5">
                            <div class="bg-white rounded-xl p-6 custom-shadow card-hover h-full">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <div class="relative flex items-center pl-4 pr-6 py-2 border border-gray-200 rounded-lg cursor-pointer hover:bg-indigo-50 transition">
                                            <input type="radio" id="manual" name="transmisi" value="manual" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500" checked>
                                            <label for="manual" class="ml-2 text-gray-700 font-medium">Manual</label>
                                        </div>
                                        <div class="relative flex items-center pl-4 pr-6 py-2 border border-gray-200 rounded-lg cursor-pointer hover:bg-indigo-50 transition">
                                            <input type="radio" id="automatic" name="transmisi" value="automatic" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                                            <label for="automatic" class="ml-2 text-gray-700 font-medium">Automatic</label>
                                        </div>
                                        <div class="relative flex items-center pl-4 pr-6 py-2 border border-gray-200 rounded-lg cursor-pointer hover:bg-indigo-50 transition">
                                            <input type="radio" id="kopling" name="transmisi" value="kopling" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                                ...
                                <div class="mb-4">
                                    <label for="cubic_centimeter" class="block mb-2 font-medium text-gray-700">Tenaga Mesin (CC)</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <input type="number" id="cubic_centimeter" name="cubic_centimeter" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: 1500" required>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="jumlah_kursi" name="jumlah_kursi" min="1" max="50" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: 5" required>
                                    </div>
                                    @error('jumlah_kursi')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="plat_nomor" name="plat_nomor" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg input-focus focus:outline-none" placeholder="Contoh: B 1234 XYZ" required>
                                    </div>
                                    @error('plat_nomor')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
        ...
        <a href="{{ route('mitra.kendaraan.kendaraanmitraView') }}" class="fixed bottom-0 right-0 m-5 p-2 rounded-full bg-primary text-white transition-all duration-300 ease-in-out hover:scale-125">
