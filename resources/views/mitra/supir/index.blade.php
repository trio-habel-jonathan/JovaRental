        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white relative w-full h-full rounded-md shadow-lg">
                <div class="absolute flex items-center justify-center top-0 right-0 z-10">
                    <div class="relative">
                    <button id="toggleButton_{{ $sopir->id_sopir }}" class="bg-transparent p-1 hover:bg-white m-1 text-white hover:text-primary rounded-full" onclick="toggleMenu('{{ $sopir->id_sopir }}')">
                    ...
                    <div id="optionsMenu_{{ $sopir->id_sopir }}" class="absolute right-0 mt-1 hidden">
                        <div class="bg-white rounded-lg shadow-lg py-1 w-28">
                            <a href="{{ route('mitra.supir.editsupirView',$sopir -> id_sopir) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <div >
                                ...
                                <label for="modal-delete-toggle-{{$loop->iteration}}" class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-gray-100 w-full text-left">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="flex flex-col items-center justify-center z-10">
                        <div class="w-24 h-24 bg-white rounded-full p-1">
                            <img class="w-full h-full rounded-full object-cover"
                                src="https://i.pinimg.com/736x/2f/57/8d/2f578d07945132849b05fbdaf78cba38.jpg" alt="">
                        </div>
            ...
            <x-modal-delete counter="{{ $loop->iteration }}"
                formAction="{{ route('mitra.supir.destroy', $sopir->id_sopir) }}"
                uuid="{{ $sopir->id_sopir }}" />
            @endforeach
