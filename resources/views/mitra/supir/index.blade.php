        ...
        @for ($i = 0; $i < 8; $i++)
            ...
            <div class="bg-transparent rounded-xl overflow-hidden h-full relative">
                ...
                <div class="absolute bottom-2 left-0 right-0 flex justify-center space-x-4 px-4">
                    <button class="bg-white text-primary p-2 rounded-full hover:text-white hover:bg-blue-500 shadow-md">
                    ...
                    <button class="bg-white text-primary p-2 rounded-full hover:text-white hover:bg-yellow-500 shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
