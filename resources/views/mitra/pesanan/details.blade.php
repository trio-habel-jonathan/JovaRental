<x-mitra-layout title="Detail Pesanan">
        ...
        <div class="flex gap-4">
            ...
            <div class="bg-white shadow-lg rounded-lg p-4 w-[35rem]">
                ...
                <div>
                    ...
                    <div class="flex flex-col bg-white p-4 space-y-4 rounded-md mt-4">
                        <h1 class="text-lg font-bold montserrat-font">Customer Details</h1>
                        <div class="space-y-2 plus-jakarta-sans-font text-sm">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <p>triohabeljonathan@gmail.com</p>
                            </div>
                            <div class="flex gap-2 items-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        window.onload = function() {
            initialActiveStep = 2; // Setting the active step to 2 (Meeting)
