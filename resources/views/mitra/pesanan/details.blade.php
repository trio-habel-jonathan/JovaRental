<x-mitra-layout title="Detail Pesanan">
    <div class="p-4">
        <div class="flex mb-4 gap-4">
            <div class="bg-white shadow-lg rounded-lg flex flex-col justify-between p-4 w-[28rem]">
                <div class="flex gap-2 items-center">
                    ...
                    <div class="montserrat-font">
                        <p class="text-xs">Total Payment</p>
                        <p class="text-2xl font-bold">IDR 4.020.000</p>
                    </div>
                </div>
            ...
            <div class="bg-white montserrat-font grid grid-cols-2 gap-4 shadow-lg p-4 rounded-md w-full">
                <div class="flex gap-2 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold">Trio Habel Jonathan</p>
                    </div>
                </div>
                <div class="flex gap-2 items-center">
                    <div class="w-10 h-10 bg-primary/20 text-primary flex items-center justify-center rounded-md">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold">franklinchang@gmail.com</p>
                    </div>
                </div>
                <div class="flex gap-2 items-center">
                    <div class="w-10 h-10 bg-primary/20 text-primary flex items-center justify-center rounded-md">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold">08123456789</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex gap-4">
            <div class="bg-white shadow-lg p-4 rounded-md w-full">
                <div>
                    <h1 class="font-bold text-md montserrat-font">Ordered Items</h1>
                </div>
                <div class="grid grid-cols-1 gap-2 overflow-auto custom-scrollbar pr-2 mt-4 h-fit max-h-96">
                    @for ($i = 1; $i < 2; $i++)
                ...
                <div class="flex flex-col justify-between items-start gap-4 mt-4">
                    <div class="flex flex-1 gap-2">
                        ...
                        <p class="text-sm text-justify">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa
                            in
                            obcaecati aut voluptates,
                            labore dolor non necessitatibus quia modi ipsam eos impedit illum corporis, iusto facilis
                            deserunt aperiam mollitia nam!</p>
                    </div>
