                    ...
                    <div id="vehicle-slider" class="flex overflow-x-auto gap-4 py-2 px-8 hide-scrollbar">
                        @foreach ($relatedVehicles as $vehicle)
                            @php
                                ...
                                $driverCost = ($searchParams['tipe_rental'] === 'dengan_sopir') ? $driver_fee * $searchParams['rentalDays'] : 0;
                                ...
                                <a href="{{ request()->fullUrlWithQuery(['selected_vehicle' => $selectedVehicle, 'vendor' => $vehicle->id_kendaraan]) }}" class="block">
                                    ...
                                    <div class="p-3">
                                        ...
                                        @if ($searchParams['extraHours'] > 0)
                                            <p class="text-xs text-gray-500">+ Ekstra {{ $searchParams['extraHours'] }} jam</p>
                                        @endif
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="md:w-2/3 p-6">
                                ...
                                <div class="flex justify-between items-center mt-6">
                                    <div>
                                        ...
                                        @endif
                                        @if ($searchParams['extraHours'] > 0)
                                            <p class="text-xs text-gray-500">+ Biaya ekstra {{ $searchParams['extraHours'] }} jam: Rp {{ number_format($extraCost, 0, ',', '.') }}</p>
                                        @endif
                                    </div>
                                    <a href="{{ route('detail', [
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center mt-4">
                                <div>
                                    <p class="text-xl font-bold text-gray-900">Rp {{ number_format($totalCost, 0, ',', '.') }}</p>
                                    @if ($searchParams['tipe_rental'] === 'dengan_sopir')
                                        <p class="text-xs text-gray-500">Termasuk biaya sopir Rp {{ number_format($driver_fee, 0, ',', '.') }}/hari</p>
                                    @endif
                                    @if ($searchParams['extraHours'] > 0)
