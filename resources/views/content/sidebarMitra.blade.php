        ...
        <div class="flex flex-col space-y-1">
            ...
            <div class="group">
                ...
                <div id="keuangan-submenu"
                    class="pl-12 max-h-0 overflow-hidden transition-all duration-300 ease-out bg-white rounded-b-lg mb-1">
                    <a href="{{route ('mitra.keuangan.index')}}"
                        class="block py-2 text-sm text-gray-600 hover:text-indigo-600">Laporan
                        Keuangan</a>
                    <a href="{{route ('mitra.keuangan.pengeluaran')}}"
            ...
            <div class="group">
                ...
                <div id="supir-submenu"
                    class="pl-12 max-h-0 overflow-hidden transition-all duration-300 ease-out bg-white rounded-b-lg mb-1">
                    <a href="{{ route('mitra.supir.supirmitraView') }}"
                        class="block py-2 text-sm text-gray-600 hover:text-indigo-600">Daftar Supir</a>
                    <a href="{{ route('mitra.supir.tambahsupir') }}"
                        class="block py-2 text-sm text-gray-600 hover:text-indigo-600">Tambah Supir</a>
            ...
            <div class="group">
                ...
                <div id="alamat-submenu"
                    class="pl-12 max-h-0 overflow-hidden transition-all duration-300 ease-out bg-white rounded-b-lg mb-1">
                    <a href="{{ route('mitra.alamat.MitraView') }}"
                        class="block py-2 text-sm text-gray-600 hover:text-indigo-600">Daftar Alamat</a>
                    <a href="{{ route('mitra.alamat.MitraCreate') }}"
                        class="block py-2 text-sm text-gray-600 hover:text-indigo-600">Tambah Alamat</a>
