<x-admin-layout title="Dashboard">
    <div class="p-4">
        <<<<<<< HEAD <div class="flex justify-between gap-4 flex-wrap items-start ">
                    ...
                    @for ($i = 0; $i < 3; $i++) <div class="bg-white rounded-md p-2 flex-1">
                        ...
                        <div>
                            <div class="grid grid-cols-3 gap-4">
                                @for ($i = 0; $i < 3; $i++) <div class="bg-white rounded-md p-2">
                    ...
                    <div class="bg-white   rounded-xl p-4 shadow-xl">
                        ...
                        <div class="bg-gray-100 w-full p-3 rounded-lg mt-2 montserrat-font text-lg">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <div class="icon-container">
                                    <img draggable="false" id="eye-open"
                                        src="https://www.svgrepo.com/show/532492/eye-alt.svg" alt="show-wallet"
                                        class="eye-icon">
                            ...
                            <p class="montserrat-font font-semibold text-2xl" id="balance"><span
                                    class="text-lg">Rp</span>
                                100.000.000</p>
                        </div>
                        ...
                        <div class="w-full p-3 rounded-lg mt-2 montserrat-font text-lg">
                            ...
                            <div class="flex items-center mt-2 mr-2 justify-start gap-3">
                                ...
                                <div>
                                    <p class="block leading-[15px]"><span
                                            class="font-bold text-sm">Transaksi</span><br><span class="text-xs">10 Jan
                                            2025</span></p>
                                </div>
                            ...
                            <div class="flex items-center mt-2 mr-2 justify-start gap-4">
                                ...
                                <div>
                                    <p class="block leading-[15px]"><span
                                            class="font-bold text-sm">Withdraw</span><br><span class="text-xs">10 Jan
                                            2025</span></p>
                                </div>
