                    ...
                    <tbody class="divide-y">
                        ...
                        <tr class="bg-white hover:bg-gray-50 transition">
                            <td class="px-6 py-4 flex items-center gap-4">
                                ...
                                @else
                                <img class="w-12 h-12" src="https://www.pngmart.com/files/23/Profile-PNG-Photo.png"
                                    alt="Default profile">
                                @endif
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="inline">
                                    <label for="modal-delete-toggle-{{$loop->iteration}}" class="text-red-600 hover:underline ml-2">Hapus</label>
                                    <x-modal-delete counter="{{ $loop->iteration }}"
                                        formAction="{{ route('admin.user.destroy', $user->id_user) }}"
                                        uuid="{{ $user->id_user }}" />
                                </div>
                            </td>
                        </tr>
