        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
            ...
            <div class="bg-white p-4 rounded-xl shadow-md space-y-2">
                ...
                <div class="flex items-center justify-end gap-2">
                    ...
                    <div class="inline">
                        <label for="modal-delete-toggle-{{$loop->iteration}}" type="submit"
                        ...
                        <x-modal-delete counter="{{ $loop->iteration }}"
                            formAction="{{ route('admin.metodePembayaran.destroy', $metode->id_metode_pembayaran_platform)}}"
                            uuid="{{ $metode->id_metode_pembayaran_platform }}" />
                    </div>
                </div>
            </div>
            @empty
