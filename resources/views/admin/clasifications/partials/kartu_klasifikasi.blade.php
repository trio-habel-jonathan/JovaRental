<div class="">
    ...
    <div class="flex flex-col gap-4 items-start p-4 relative shadow-md rounded-md">
        ...
        <h6 class="font-bold text-gray-700 montserrat-font text-lg uppercase">{{$kategori->nama_kategori}}</h6>
        <p class="text-sm">{{$kategori->deskripsi}}</p>
        <div class="flex items-center justify-between w-full">
            <p class="font-medium text-sm text-gray-700">{{count($kategori->kendaraans)}} Vehicles</p>
            <p class="font-bold uppercase text-xs text-white px-4 py-0.5 bg-primary rounded-full text-center">
