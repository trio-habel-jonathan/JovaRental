    ...
    <div class="flex flex-col sm:flex-row w-full min-h-screen gap-4 p-4 mt-8">
        ...
        <div class="order-1 sm:order-1 sm:w-[65%] w-full bg-white p-6 md:p-8 rounded-tl-2xl rounded-bl-2xl shadow-lg">
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-primary text-primary rounded-full w-6 h-6 flex items-center justify-center">1</span>
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-primary text-primary rounded-full w-6 h-6 flex items-center justify-center">2</span>
                Mohon Transfer ke
            </h1>
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-primary text-primary rounded-full w-6 h-6 flex items-center justify-center">3</span>
                Anda Sudah Membayar ?
            </h1>
