    ...
    <div class="flex flex-col sm:flex-row w-full min-h-screen bg-gray-50 mt-8">
        ...
        <div class="order-1 sm:order-1 sm:w-[65%] w-full bg-white p-6 md:p-8 rounded-tl-2xl rounded-bl-2xl shadow-lg">
                ...
                <span class="bg-purple-100 text-purple-600 p-2 rounded-lg mr-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 10a4 4 0 118 0c0 1.657-1.343 3-3 3H12v2m0 4h.01" />
                    </svg>
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-purple-500 text-purple-500 rounded-full w-6 h-6 flex items-center justify-center">1</span>
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-purple-500 text-purple-500 rounded-full w-6 h-6 flex items-center justify-center">2</span>
                Mohon Transfer ke
            </h1>
            ...
            <div
                class="p-6 bg-purple-50 rounded-xl shadow-sm hover:shadow-md transition-all mb-6 border border-gray-100">
                <div class="border-gray-200">
                    <h3 class="text-xl font-bold text-purple-800 mb-4 border-b text-center py-2">Bank Central Asia ( BCA
                        )</h3>

                    <div class="flex justify-between py-2 mb-2">
                        <p class="text-gray-600">No. Rekening</p>
                        <p class="font-medium text-gray-800">08928276182</p>
                    </div>

                    <div class="flex justify-between py-2 mb-2">
                        <p class="text-gray-600">Nama Penerima</p>
                        <p class="font-medium text-gray-800">Wijaya Rent Car</p>
                    </div>

                    <div class="flex justify-between py-2">
                        <p class="text-gray-600">Jumlah Transfer</p>
                        <p class="font-medium text-green-600">Rp. 1.220.000</p>
                    </div>
                </div>
            </div>
            ...
            <h1 class="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
                <span
                    class="border border-purple-500 text-purple-500 rounded-full w-6 h-6 flex items-center justify-center">3</span>
                Anda Sudah Membayar ?
            </h1>
