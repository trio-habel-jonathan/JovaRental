                    ...
                    <div class="space-y-3">
                        <div class="flex flex-col items-center p-12 border border-dashed border-gray-300 rounded-lg">
                            ...
                            <label for="file-upload"
                                class="cursor-pointer bg-primary hover:bg-primary text-white py-2 px-4 rounded-md transition-colors">
                                Unggah Bukti Pembayaran
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('buktiPenyewaanKendaraan') }}"
                                class="bg-primary hover:bg-primary text-white font-medium py-3 px-8 rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2">
                                Lanjutkan
