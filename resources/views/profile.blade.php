<x-user-layout title="profile">
    ...
    <div class="flex flex-col gap-2 lg:flex-row items-start justify-between mx-auto max-w-[1600px] h-[90.5vh]">
        ...
        <div class="w-full h-full lg:w-72 flex flex-col bg-white shadow-md p-4 mb-4 lg:mb-0 overflow-y-auto">
            <form action="" class="p-2 border rounded-xl mb-8">
            ...
            <ul class="w-full space-y-2">
                <li>
                    <a href="{{ route('profile') }}"
                        class="w-full flex gap-2 items-center p-2 rounded-xl text-gray-500 hover:text-primary font-medium montserrat-font transition-all duration-300 ease-in-out hover:bg-primary/20">
                        <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li>
                    <a href="{{ route('history') }}"
                        class="text-sm w-full flex gap-2 items-center p-2 rounded-xl text-gray-500 hover:text-primary font-medium montserrat-font transition-all duration-300 ease-in-out hover:bg-primary/20">
                        <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
