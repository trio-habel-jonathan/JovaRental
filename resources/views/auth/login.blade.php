<x-auth-layout title="Login">
    <div class="w-full h-full grid grid-cols-2">
        ...
        <div class='h-full flex flex-col justify-center gap-4 items-center'>
            ...
            <button class="flex justify-center p-2 items-center gap-4 border border-gray-300 shadow-2xl rounded-2xl w-1/2 transition-all duration-300 ease-in-out hover:scale-105">
