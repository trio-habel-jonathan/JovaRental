<x-auth-layout title="Login">
    <div class="w-full h-full flex">
        ...
        <div class='h-full w-full flex flex-col justify-center gap-4 items-center'>
            ...
            <form action="{{ route('entitas-action') }}" class="w-3/4 xl:w-1/2 space-y-8" method="POST">
                @csrf
                @method('POST')
                <div>
                ...
                <div class="flex flex-col gap-4 items-center justify-end">
                    ...
                    <p>Already Have Account? <a href="{{ route('login-action') }}" class="text-blue-600">Login</a></p>
                </div>
            </form>
        </div>
    </div>
