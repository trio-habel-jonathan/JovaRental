            ...
            <form action="" class="w-3/4 xl:w-1/2 space-y-8">
                ...
                <div>
                    ...
                    <div
                        ...
                        <input type="text" name="email_rental"
                            class="bg-transparent w-full text-black focus:outline-none placeholder:font-semibold"
                            placeholder="Email Rental...">
                    </div>
                </div>
                <div>
                    <label for="">Alamat Rental</label>
                    <div
                        class="flex gap-4 items-center text-gray-400 border-b-2 border-gray-400 bg-transparent p-3 transition-all duration-300 ease-in-out">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input type="text" name="alamat_rental"
                            class="bg-transparent w-full text-black focus:outline-none placeholder:font-semibold"
                            placeholder="Alamat Rental...">
                    </div>
                </div>
                <div>
                    <label for="">Nomor Handphone Rental</label>
                    <div
                        class="flex gap-4 items-center text-gray-400 border-b-2 border-gray-400 bg-transparent p-3 transition-all duration-300 ease-in-out">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input type="text" name="no_hp_rental"
                            class="bg-transparent w-full text-black focus:outline-none placeholder:font-semibold"
                            placeholder="Nomor Handphone Rental...">
                    </div>
                </div>
