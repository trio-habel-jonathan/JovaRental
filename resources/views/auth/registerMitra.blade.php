<x-auth-layout title="Register">
    ...
    <div class="grid grid-cols-2">
        ...
        <div class="w-full h-full py-4 flex flex-col justify-center gap-4 items-center">
            ...
            <form action="" method="POST" class="w-3/4 grid grid-cols-2 gap-6">
                @csrf
                <div>
                    ...
                    <div
                        ...
                        <input type="text" name="nama_mitra" id="nama_mitra"
                            class="bg-transparent w-full text-black focus:outline-none" placeholder="Nama Mitra...">
                    </div>
                </div>
                <div>
                    ...
                    <div
                        ...
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            class="flex gap-4 items-center text-gray-400 border-b-2 border-gray-400 bg-transparent p-3
                            transition-all duration-300 ease-in-out">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                >>>>>>> fb9815d7e804d47b7cba94a7098571c2db2184e2
                                <path
