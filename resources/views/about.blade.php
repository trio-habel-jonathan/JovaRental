<x-user-layout title="About">
    ...
    <center>
        <header data-aos="zoom-in" class=" rounded-xl border m-7 h-[25rem] overflow-hidden shadow-md max-w-[1600px] ">
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="text-center mb-12">
            <h2 data-aos="fade-right" class="text-purple-600 font-semibold text-start text-xl">
                Siapa Kami
            </h2>
            <div class="grid lg:grid-cols-2 gap-10">
                <h1 data-aos="fade-right" class="text-3xl md:text-4xl font-bold text-start mt-2 montserrat-font ">
                    Menghubungkan Perjalanan, Mewujudkan Kemudahan
                </h1>

                <p data-aos="fade-up" class="text-justify plus-jakarta-sans-font ">Di Jova Rental, kami percaya bahwa
                    setiap perjalanan
                    harus
                    mudah, nyaman, dan
        ...
        <div data-aos="fade-up"
            class="bg-white py-5 rounded-md shadow-md flex flex-col flex-1 gap-10 lg:gap-0 lg:flex-row lg:justify-between">
    ...
    <div class="text-center max-w-[1600px] mx-auto px-5 my-12">
        <h1 data-aos="fade-up" class="text-3xl font-semibold mb-8">
            Meet our
        ...
        <div data-aos="fade-up" id="team-slider" class="relative overflow-hidden">
        ...
        <div data-aos="fade-up" class="flex justify-center space-x-4 mt-8">
    ...
    <section class="py-12 px-8 ">
        <div class="mx-auto max-w-[1600px]  ">
            <div class="grid gap-1  pb-5">
                <h2 data-aos="fade-up"
                    class="w-full text-center text-gray-900 text-4xl font-bold font-manrope leading-normal">Galeri Kami
                </h2>
                <div data-aos="fade-up" class="w-full text-center text-gray-600 text-lg font-normal leading-8">
                    Bersama, kami wujudkan visi
                    menjadi nyata.</div>
            </div>
            <div class="gallery">
                <div class="flex flex-col mb-10">
                    <div class="grid md:grid-cols-12 gap-8 lg:mb-11 mb-7">
                        <div data-aos="fade-right" class="md:col-span-4 md:h-[404px] h-[277px] w-full rounded-3xl">
                        ...
                        <div data-aos="fade-right" data-aos-delay="150" class="md:col-span-8 md:h-[404px] h-[277px] w-full rounded-3xl">
                    ...
                    <div class="grid md:grid-cols-3 grid-cols-1 gap-8">
                        <div data-aos="fade-right" data-aos-delay="300" class="h-[277px] w-full rounded-3xl">
                        ...
                        <div data-aos="fade-right" data-aos-delay="450" class="h-[277px] w-full rounded-3xl">
                            <img src="https://pagedone.io/asset/uploads/1713943039.png" alt="Gallery image"
                                class="gallery-image object-cover rounded-3xl hover:grayscale transition-all duration-700 ease-in-out mx-auto w-full h-full">
                        </div>
                        <div data-aos="fade-right" data-aos-delay="600" class="h-[277px] w-full rounded-3xl">
