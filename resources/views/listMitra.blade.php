<x-user-layout title="Daftar Kendaraan">
    <div class="px-6 my-4 max-w-[1600px] mx-auto">
        ...
        <div class="flex gap-4">
                    ...
                    <div
                        ...
                        <div class="flex gap-4 flex-row">
                            ...
                            <div class="plus-jakarta-sans-font space-y-2">
                                <h1 class="text-2xl font-bold montserrat">Pengusaha Sukses</h1>
                                <p class="font-semibold">08123456789</p>
                                <p class="w-3/4">Komplek Tunas 2 Industrial Estate Blok 7D, Berlian, Batam Centre,
                                    Belian, Batam Kota,
            ...
            <div class="w-96 bg-white rounded-xl shadow-md border border-gray-100 p-4">
                <h3 class="text-xl font-bold text-gray-800 mb-5">Cari & Filter</h3>
                <form id="formFilter" class="grid grid-cols-1 gap-4">
                    <!-- Search Box -->
                    <div>
