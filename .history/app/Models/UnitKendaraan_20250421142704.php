...
class UnitKendaraan extends Model
{
    ...
    public function UnitkendaraanToDetailPemesanan()
    {
        return $this->hasMany(DetailPemesanan::class, 'id_unit', 'id_unit');
    }

    public function detailPemesanan()
{
    return $this->hasMany(DetailPemesanan::class, 'id_unit');
}
