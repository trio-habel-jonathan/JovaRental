...
{
    // Get the data for kendaraan
    $kendaraan = $this->getKendaraanData($id_unit);  // Assuming this method fetches the kendaraan data based on id_unit.

    // Pass id_unit directly to the view
    return view('mitra.pengembalian_kendaraan.form', compact('kendaraan', 'id_unit'));
}
