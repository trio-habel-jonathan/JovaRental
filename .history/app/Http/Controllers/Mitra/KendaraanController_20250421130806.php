...
class KendaraanController extends Controller
{
    ...
    public function pengembalianKendaraan(){
        ...
        // Ambil semua kendaraan milik mitra
        $unitIds = [];
    
        foreach ($mitra->kendaraans as $kendaraan) {
            if (
                $kendaraan->KendaraanToUnitKendaraan &&
                $kendaraan->KendaraanToUnitKendaraan->UnitkendaraanToDetailPemesanan
            ) {
                $unitIds[] = $kendaraan
                    ->KendaraanToUnitKendaraan
                    ->UnitkendaraanToDetailPemesanan
                    ->id_unit;
            }
        }
