<div class="flex h-screen sticky top-0 plus-jakarta-sans-font">
    <!-- Sidebar -->
    <div class="w-64 text-xs bg-white p-5 border-r border-gray-200 flex flex-col overflow-y-auto">
        <!-- Logo -->
        ...
        <div class="text-gray-700">
            <div>
                <p class="text-sm font-bold mb-2">Main</p>
            ...
            <div class="mt-4">
                <p class="text-sm font-bold mb-2">App</p>
                <ul class="flex flex-col gap-2">
                    ...
                    <li>
                        <a href="{{route('admn.pengajuan.kemitraan')}}"
                            class="flex font-semibold items-center gap-2 hover:text-primary hover:bg-primary/20 p-2 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M16 3H8a2 2 0 00-2 2v14a2 2 0 002 2h8a2 2 0 002-2V7l-4-4z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M14 3v4h4M12 12l2 2m0 0l-3 3H9v-2l3-3z" />
                              </svg>
            ...
            <div class="mt-4">
                <p class="text-sm font-bold mb-2">Add On</p>
                <ul class="flex flex-col gap-2">
                    <li>
        ...
        <div class="mt-auto">
            <!-- Logout -->
            <div class="flex items-center px-4 py-3 rounded-lg text-red-500 cursor-pointer hover:bg-red-500/20 mt-6">
                <div class="mr-3">
