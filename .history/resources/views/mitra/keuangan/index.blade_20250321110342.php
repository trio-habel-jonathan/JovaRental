...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function getResponsiveOptions() {
        const isSmallScreen = isTabletOrMobile();
        
        return {
            responsive: true,
            maintainAspectRatio: false,
            aspectRatio: isSmallScreen ? 1.25 : 2,
            plugins: {
                legend: {
                    display: false
                },
                ...
                y: {
                    ...
                    ticks: {
                        callback: function(value) {
                            return isSmallScreen ? 'Rp' + (value/1000000).toFixed(1) + 'M' : 'Rp' + value.toLocaleString('id-ID');
                        },
                        font: {
    ...
    const chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointRadius: isTabletOrMobile() ? 3 : 5
            }]
        },
    ...
    window.addEventListener('resize', function() {
        ...
        chart.data.datasets[0].pointRadius = isTabletOrMobile() ? 3 : 5;
        chart.update();
    });
    ...
    function adjustChartContainer() {
        ...
        if (chartContainer) {
            chartContainer.style.height = isTabletOrMobile() ? '200px' : '300px';
        }
    }
    
    // Initial adjustment and listen for resizing
