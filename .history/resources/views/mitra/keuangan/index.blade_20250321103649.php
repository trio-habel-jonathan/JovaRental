<x-mitra-layout title="keuangan">
    ...
    <div class="mt-4 mx-4">
        <div class="bg-white p-4 rounded-lg mb-4 shadow">
            ...
            <div class="text-center text-sm text-gray-500 mt-2">
                Bulan (Difilter berdasarkan tahun 2023)
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Transactions data with additional index values
            const transactions = [
                { date: '29 Jun', balance: 325000, index: 100 },
                { date: '30 Jun', balance: 365000, index: 112 },
                { date: '30 Jun', balance: 315000, index: 97 },
                { date: '01 Jul', balance: 815000, index: 251 },
                { date: '01 Jul', balance: 638510, index: 196 },
                { date: '01 Jul', balance: 615510, index: 189 },
                { date: '01 Jul', balance: 650510, index: 200 }
            ];
            ...
            const chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: 'Index',
                            data: transactions.map(t => t.index),
