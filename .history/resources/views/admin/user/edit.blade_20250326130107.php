                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-4 p-2">
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="is_verified" value="{{ now() }}" class="hidden peer"
                                ...
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="is_verified" value="{{ null }}" class="hidden peer"
                                        {{ !$user->is_verified ? 'checked' : '' }}>
                                    <div class="w-4 h-4 border-2 border-gray-400 rounded-full flex items-center justify-center peer-checked:border-blue-500 peer-checked:bg-blue-500">
                                        <div class="w-2.5 h-2.5 bg-white rounded-full"></div>
                                    </div>
                    ...
                    <div class="bg-white rounded-lg flex flex-col gap-4 p-4 shadow-lg">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="relative flex items-center justify-center w-full gap-4">
                                <input type="file" name="foto_profil" id="fileInput" class="hidden" accept="image/*">
                                <div id="dropzone" class="cursor-pointer">
                                    <img id="imagePreview" class="w-48 h-48 object-cover rounded-lg bg-gray-100 {{ $user->foto_profil ? '' : 'hidden' }}"
                                        src="{{ $user->foto_profil ? asset('storage/' . $user->foto_profil) : '' }}">
                                    <div id="imageIcon" class="absolute left-18 top-12 flex justify-center items-center w-24 h-24 text-gray-300 {{ $user->foto_profil ? 'hidden' : '' }}">
