<x-admin-layout title="User Data">
    <div class="p-4">
        <form action="{{ route('admin.user.update', ['id_user' => $user->id_user]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-4 p-2">
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="is_verified" value="1" class="hidden peer"
                                    <input type="radio" name="is_verified" value="1" {{ $user->is_verified ? 'checked' : '' }}>
