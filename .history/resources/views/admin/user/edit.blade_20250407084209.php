                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="bg-white rounded-lg flex flex-col gap-4 p-4 shadow-lg">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="relative w-48 h-48 flex items-center justify-center bg-gray-100 rounded-lg">
                                <img id="imagePreview" 
                                    src="{{ $user->foto_profil ? asset('storage/' . $user->foto_profil) : '' }}" 
                                    class="w-full h-full object-cover rounded-lg {{ $user->foto_profil ? '' : 'hidden' }}">
                                <div id="imageIcon"
                                    class="absolute inset-0 flex justify-center items-center text-gray-400 {{ $user->foto_profil ? 'hidden' : '' }}">
                            ...
                            <div id="dropzone" 
                                class="flex-1 p-4 border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:border-primary transition-colors">
                                <p class="text-gray-500 text-sm">
                                    Click to select or drag and drop an image to upload
                                </p>
