                ...
                <div class="bg-white flex justify-center items-center w-full shadow-lg rounded-lg gap-2 p-4">
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" id="full_name" name="full_name" class="border rounded-md border-gray-300 p-2 focus:outline-none"
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-4 p-2">
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="verified" value="1" class="hidden peer" checked>
                ...
                <div class="flex flex-col gap-4">
                    <div class="bg-white rounded-lg flex flex-col gap-4 p-4 shadow-lg">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" class="border rounded-md border-gray-300 p-2 focus:outline-none"
                    ...
                    <div class="bg-white rounded-lg flex flex-col gap-4 p-4 shadow-lg">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="relative flex items-center justify-center w-full gap-4">
                                ...
                                <div id="imageIcon"
                                    class="absolute left-18 top-12 flex justify-center items-center w-24 h-24 text-gray-300">
                            ...
                            <div id="dropzone" class="w-full p-2 border-2 border-dashed border-gray-500 rounded-lg text-center cursor-pointer">
                                ...
                                <input type="file" id="fileInput" name="photo_profile" accept="image/*" class="hidden">
                            </div>
                        </div>
                    </div>
                </div>
