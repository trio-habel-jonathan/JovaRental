                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-4 p-2">
                                <label class="flex items-center space-x-3 cursor-pointer">
                                    <input type="radio" name="is_verified" value="1" class="hidden peer" {{ $user->is_verified ? 'checked' : '' }}>
                    ...
                    <div class="bg-white rounded-lg flex flex-col gap-4 p-4 shadow-lg">
                        ...
                        <div class="grid grid-cols-2 place-items-center gap-4">
                            <div class="relative flex items-center justify-center w-full gap-4">
                                <img id="imagePreview" 
                                    ...
                                    class="w-48 h-48 object-cover rounded-lg bg-gray-100 {{ $user->foto_profil ? '' : 'hidden' }}">
                                <div id="imageIcon"
                                    class="absolute left-18 top-12 flex justify-center items-center w-24 h-24 text-gray-300 {{ $user->foto_profil ? 'hidden' : '' }}">
                            ...
                            <div id="dropzone"
                                ...
                                <p class="text-gray-400 text-sm">Click to select or simply drag and drop an image here to upload effortlessly.</p>
                        ...
                        <div class="grid grid-cols-2 place-items-center gap-4">
                            <div class="relative flex items-center justify-center w-48 h-48 gap-4">
                                ...
                                <div id="imageIcon"
                                    class="absolute inset-0 flex justify-center items-center w-full h-full text-gray-300">
