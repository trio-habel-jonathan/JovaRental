...
Route::prefix('mitra')->name('mitra.')->middleware(['auth', 'CheckRole:mitra'])->group(function () {
    Route::post('/pengembalian/store', [KendaraanController::class, 'storePengembalian'])->name('pengembalian.store');

    Route::get('/pengembalian/create', [KendaraanController::class, 'PengembalianKendaraanView'])->name('pengembalian.create');
