...
Route::prefix('mitra')->name('mitra.')->middleware(['auth', 'CheckRole:mitra'])->group(function () {
    Route::get('/mitra/pengembalian/create/{id_unit}', [KendaraanController::class, 'create']);
    Route::post('/mitra/pengembalian/store/{id_unit}', [KendaraanController::class, 'storePengembalian']);
