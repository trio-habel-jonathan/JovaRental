...
Route::prefix('mitra')->name('mitra.')->group(function () {
    ...
    Route::get('/pemasukan', [MitraPageController::class, 'keuanganMitraView'])->name('keuangan.index'); // Pastikan rute memiliki nama ini
    Route::get('/pengeluaran', [MitraPageController::class, 'keuanganMitraView'])->name('keuangan.index'); // Pastikan rute memiliki nama ini
