...
Route::prefix('mitra')->name('mitra.')->group(function () {
    ...
    Route::prefix('kendaraan')->name('kendaraan.')->group(function () {
        Route::get('/index', [MitraPageController::class, 'kendaraanmitraView'])->name('kendaraanmitraView');
...
=======
    Route::prefix('supir')->name('supir.')->group(function () {
        Route::get('/index', [SupirPageController::class, 'supirmitraView'])->name('supirmitraView');
        Route::get('/create', [SupirPageController::class, 'tambahsupir'])->name('tambahsupir');
        Route::get('/edit', [SupirPageController::class, 'editsupir'])->name('editsupir');
    });
>>>>>>> a037de70e7edc02a9ac9ed79ff0b9dc036151cb5

    Route::prefix('pesanan')->name('pesanan.')->group(function () {
        Route::get('/index', [MitraPageController::class, 'pesananmitraView'])->name('pesananmitraView');
