...
Route::prefix('mitra')->name('mitra.')->middleware(['auth', 'CheckRole:mitra'])->group(function () {
    Route::get('/pengembalian/create/{id_unit}', [KendaraanController::class, 'PengembalianKendaraanView'])->name('');
    Route::post('/pengembalian/store/{id_unit}', [KendaraanController::class, 'storePengembalian']);
