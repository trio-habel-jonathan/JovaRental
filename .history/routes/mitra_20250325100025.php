...
Route::prefix('mitra')->name('mitra.')->group(function () {
    ...
    Route::get('/pemasukan', [MitraPageController::class, 'pemasukan'])->name('keuangan.pengeluaran'); // Pastikan rute memiliki nama ini
    Route::get('/pengeluaran', [MitraPageController::class, 'pengeluaran'])->name('keuangan.pemasukan'); // Pastikan rute memiliki nama ini
