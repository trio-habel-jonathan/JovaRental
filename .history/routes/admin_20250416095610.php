...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::patch('/mitra/{id}/verifikasi', [MitraController::class, 'verifikasi'])->name('admin.mitra.verifikasi');
    Route::patch('/mitra/{id}/tolak', [MitraController::class, 'tolak'])->name('admin.mitra.tolak');
